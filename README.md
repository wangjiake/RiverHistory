...
Don't want to install Python or PostgreSQL? **[Run with Docker](https://github.com/wangjiake/JKRiver/tree/main/docker)** — includes demo data, supports OpenAI / DeepSeek / Groq.
